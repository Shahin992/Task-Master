...
const image_hosting_key = import.meta.env.VITE_APIIMGBB;
        ...
        <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            ...
            <div className="space-y-5">
              ...
              <button
                onClick={() => handleSocial(githubSignIn)}
                className="w-full py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-gray-800 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800 hover:scale-110 hover:border-2 hover:border-green-600 mb-2 mt-2"
              >
                <FaGithub className="w-4 h-auto"></FaGithub> Sign up with Github
              </button>
            </div>
            <p className="text-[#737373] text-center mt-2 text-lg">
              Already have an account?{" "}
              <Link to="/login">
                <span className="text-[#00bf58] font-bold text-lg">
                  Sign In
                </span>
              </Link>
            </p>
