...
const TaskCard = ({ task, refetch }) => {
  ...
  const handleDeleteTask = (id) => {
    console.log(id);
    axios
      .delete(`https://task-management-server-main-ruby.vercel.app/tasks/${id}`)
      .then((data) => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .patch(
        `https://task-management-server-main-ruby.vercel.app/tasks/${task._id}`,
        updatedTask
      )
      .then((res) => {
